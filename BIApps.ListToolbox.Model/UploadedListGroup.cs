    ...
    public class UploadedListGroup : INotifyCollectionChanged, IEnumerable<UploadedList> {
        ...
        public UploadedList this[int index] {
            ...
            set {
                ...
                CollectionChanged(UploadedLists, new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Reset));
                CollectionChanged(ColumnsInCommon, new NotifyCollectionChangedEventArgs(NotifyCollectionChangedAction.Reset));
            }
        }
        ...
        /// </summary>
        public ObservableCollection<string> ColumnsInCommon { get; private set; }

        /// <summary>
        /// Gets or sets the location that the files in the list come from.
        /// </summary>
        ...
        public UploadedListGroup() {
            ...
            ColumnsInCommon = new ObservableCollection<string>();
        }
        ...
        public void Add(UploadedList list) {
            ...
            ColumnsInCommon.AddRange(GetColumnsInCommon());
        }
        ...
        /// </summary>
        public void Clear() {
            foreach(var list in UploadedLists.ToList()) {
                Remove(list);
            }
        }
        ...
        private IEnumerable<string> GetColumnsInCommon() {
            return from list in UploadedLists
                   ...
                   into c
                   group c.tableName.Length by c.colName
                   into colCount
        ...
        public IEnumerator<UploadedList> GetEnumerator() {
            return UploadedLists.TakeWhile(list => list != null).GetEnumerator();
        }
