...
namespace BIApps.ListToolbox.ListHelpers.Uploaders {
    ...
    /// <summary>
    /// An uploader which takes an Excel 2010 file including its full directory and uploads 
    /// it as a DataTable. 
    /// </summary>
    /// <remarks>
    ...
    /// </remarks>
    internal class XlsxListUploader : IListUploader {
        ...
        /// <summary>
        /// Initializes a <see cref="XlsxListUploader"/>, which uploads a list based on a filename.
        /// including the directory.
        /// </summary>
        /// <param name="sourceName">The filename including directory of the file to be uploaded.</param>
        public XlsxListUploader(string sourceName) {
        ...
        /// <summary>
        /// Uploads a list from an Excel 2010 file using an OLE DB connection.
